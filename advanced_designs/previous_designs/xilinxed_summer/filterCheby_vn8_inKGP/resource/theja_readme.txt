log on 28th: v32
citi.v
this does the filtering part,delivering the interpolated values to be DACed.
the citi is working. there seems to be some issue with scaling of the output which needs to be sorted out.
