...
yapproximateScaled = ci*TevaluatedScaled'/2^16;



figure;
hold on;
plot(xnewlocations,yapproximate*2^15,'r'); % plot chebyshev expansion values
plot(xnewlocations,yexact*2^15,'b'); % plot exact function values
plot(xnewlocations,yapproximateScaled*4,'g'); % plot chebyshev expansion values
hold off;
